...
class TestAddresses:
    ...
    def test_method_update(self, client: Pymews) -> None:
        address = client.api.connector.v1.addresses.update(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            address_updates=[{"address_id": "fc7b2df3-de66-48a6-907d-af4600ecd892"}],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
        )
        assert_matches_type(AddressResult, address, path=["response"])
    ...
    def test_method_update_with_all_params(self, client: Pymews) -> None:
        address = client.api.connector.v1.addresses.update(
            ...
            address_updates=[
                {
                    "address_id": "fc7b2df3-de66-48a6-907d-af4600ecd892",
                    "city": {"value": "Prague"},
                    "country_code": {"value": "CZ"},
                    "country_subdivision_code": {"value": None},
                    "line1": {"value": "I.P. Pavlova 5"},
                    "line2": {"value": None},
                    "postal_code": {"value": "12000"},
                }
            ],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
    ...
    def test_raw_response_update(self, client: Pymews) -> None:
        response = client.api.connector.v1.addresses.with_raw_response.update(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            address_updates=[{"address_id": "fc7b2df3-de66-48a6-907d-af4600ecd892"}],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
    ...
    def test_streaming_response_update(self, client: Pymews) -> None:
        with client.api.connector.v1.addresses.with_streaming_response.update(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            address_updates=[{"address_id": "fc7b2df3-de66-48a6-907d-af4600ecd892"}],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
    ...
    def test_method_list(self, client: Pymews) -> None:
        address = client.api.connector.v1.addresses.list(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
            limitation={"count": 10},
    ...
    def test_method_list_with_all_params(self, client: Pymews) -> None:
        address = client.api.connector.v1.addresses.list(
            ...
            updated_utc={
                "end_utc": parse_datetime("2022-12-17T00:00:00Z"),
                "start_utc": parse_datetime("2022-12-10T00:00:00Z"),
            },
        )
        assert_matches_type(AddressListResponse, address, path=["response"])
    ...
    def test_raw_response_list(self, client: Pymews) -> None:
        response = client.api.connector.v1.addresses.with_raw_response.list(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
            limitation={"count": 10},
    ...
    def test_streaming_response_list(self, client: Pymews) -> None:
        with client.api.connector.v1.addresses.with_streaming_response.list(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
            limitation={"count": 10},
    ...
    def test_method_delete(self, client: Pymews) -> None:
        address = client.api.connector.v1.addresses.delete(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            address_ids=["cefa640f-43fa-4a02-8d20-f97f68e19ed5", "44108366-8e9b-4007-844b-8ebcca4ac009"],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
        )
        assert_matches_type(object, address, path=["response"])
    ...
    def test_raw_response_delete(self, client: Pymews) -> None:
        response = client.api.connector.v1.addresses.with_raw_response.delete(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            address_ids=["cefa640f-43fa-4a02-8d20-f97f68e19ed5", "44108366-8e9b-4007-844b-8ebcca4ac009"],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
    ...
    def test_streaming_response_delete(self, client: Pymews) -> None:
        with client.api.connector.v1.addresses.with_streaming_response.delete(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            address_ids=["cefa640f-43fa-4a02-8d20-f97f68e19ed5", "44108366-8e9b-4007-844b-8ebcca4ac009"],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
    ...
    def test_method_add(self, client: Pymews) -> None:
        address = client.api.connector.v1.addresses.add(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            addresses=[{"account_id": "3db2c989-7d95-42b4-a502-a9f246db1634"}],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
        )
        assert_matches_type(AddressResult, address, path=["response"])
    ...
    def test_method_add_with_all_params(self, client: Pymews) -> None:
        address = client.api.connector.v1.addresses.add(
            ...
            addresses=[
                {
                    "account_id": "3db2c989-7d95-42b4-a502-a9f246db1634",
                    "city": "Dortmund",
                    "country_code": "DE",
    ...
    def test_raw_response_add(self, client: Pymews) -> None:
        response = client.api.connector.v1.addresses.with_raw_response.add(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            addresses=[{"account_id": "3db2c989-7d95-42b4-a502-a9f246db1634"}],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
    ...
    def test_streaming_response_add(self, client: Pymews) -> None:
        with client.api.connector.v1.addresses.with_streaming_response.add(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            addresses=[{"account_id": "3db2c989-7d95-42b4-a502-a9f246db1634"}],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
...
class TestAsyncAddresses:
    ...
    async def test_method_update(self, async_client: AsyncPymews) -> None:
        address = await async_client.api.connector.v1.addresses.update(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            address_updates=[{"address_id": "fc7b2df3-de66-48a6-907d-af4600ecd892"}],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
    ...
    async def test_raw_response_update(self, async_client: AsyncPymews) -> None:
        response = await async_client.api.connector.v1.addresses.with_raw_response.update(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            address_updates=[{"address_id": "fc7b2df3-de66-48a6-907d-af4600ecd892"}],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
    ...
    async def test_streaming_response_update(self, async_client: AsyncPymews) -> None:
        async with async_client.api.connector.v1.addresses.with_streaming_response.update(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            address_updates=[{"address_id": "fc7b2df3-de66-48a6-907d-af4600ecd892"}],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
    ...
    async def test_method_list(self, async_client: AsyncPymews) -> None:
        address = await async_client.api.connector.v1.addresses.list(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
            limitation={"count": 10},
    ...
    async def test_raw_response_list(self, async_client: AsyncPymews) -> None:
        response = await async_client.api.connector.v1.addresses.with_raw_response.list(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
            limitation={"count": 10},
    ...
    async def test_streaming_response_list(self, async_client: AsyncPymews) -> None:
        async with async_client.api.connector.v1.addresses.with_streaming_response.list(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
            limitation={"count": 10},
    ...
    async def test_method_delete(self, async_client: AsyncPymews) -> None:
        address = await async_client.api.connector.v1.addresses.delete(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            address_ids=["cefa640f-43fa-4a02-8d20-f97f68e19ed5", "44108366-8e9b-4007-844b-8ebcca4ac009"],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
    ...
    async def test_raw_response_delete(self, async_client: AsyncPymews) -> None:
        response = await async_client.api.connector.v1.addresses.with_raw_response.delete(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            address_ids=["cefa640f-43fa-4a02-8d20-f97f68e19ed5", "44108366-8e9b-4007-844b-8ebcca4ac009"],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
    ...
    async def test_streaming_response_delete(self, async_client: AsyncPymews) -> None:
        async with async_client.api.connector.v1.addresses.with_streaming_response.delete(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            address_ids=["cefa640f-43fa-4a02-8d20-f97f68e19ed5", "44108366-8e9b-4007-844b-8ebcca4ac009"],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
    ...
    async def test_method_add(self, async_client: AsyncPymews) -> None:
        address = await async_client.api.connector.v1.addresses.add(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            addresses=[{"account_id": "3db2c989-7d95-42b4-a502-a9f246db1634"}],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
    ...
    async def test_raw_response_add(self, async_client: AsyncPymews) -> None:
        response = await async_client.api.connector.v1.addresses.with_raw_response.add(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            addresses=[{"account_id": "3db2c989-7d95-42b4-a502-a9f246db1634"}],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
    ...
    async def test_streaming_response_add(self, async_client: AsyncPymews) -> None:
        async with async_client.api.connector.v1.addresses.with_streaming_response.add(
            access_token="C66EF7B239D24632943D115EDE9CB810-EA00F8FD8294692C940F6B5A8F9453D",
            addresses=[{"account_id": "3db2c989-7d95-42b4-a502-a9f246db1634"}],
            client="Sample Client 1.0.0",
            client_token="E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
