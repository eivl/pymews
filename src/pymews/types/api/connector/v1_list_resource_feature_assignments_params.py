...
__all__ = ["V1ListResourceFeatureAssignmentsParams", "Limitation", "UpdatedUtc"]


class V1ListResourceFeatureAssignmentsParams(TypedDict, total=False):
    ...
    resource_feature_ids: Required[Annotated[List[str], PropertyInfo(alias="ResourceFeatureIds")]]
    """
    ...
    resource_feature_assignment_ids: Annotated[Optional[List[str]], PropertyInfo(alias="ResourceFeatureAssignmentIds")]
