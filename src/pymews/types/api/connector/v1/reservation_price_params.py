...
class ReservationPriceParams(TypedDict, total=False):
    ...
    """Parameters of the reservations to price.

    Note that `CustomerId` is not required when pricing reservations.
    """
