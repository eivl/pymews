...
__all__ = ["VoucherCodeListParams", "Limitation", "UpdatedUtc"]


class VoucherCodeListParams(TypedDict, total=False):
    ...
    voucher_ids: Required[Annotated[List[str], PropertyInfo(alias="VoucherIds")]]
    ...
    voucher_code_ids: Annotated[Optional[List[str]], PropertyInfo(alias="VoucherCodeIds")]
