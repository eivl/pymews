...
__all__ = [
    ...
    "ReservationReservationOptions",
    "ReservationReservationPersonCount",
]


class ReservationReservationOptions(BaseModel):
...
class ReservationReservationPersonCount(BaseModel):
...
class ReservationReservation(BaseModel):
    ...
    options: ReservationReservationOptions = FieldInfo(alias="Options")
    ...
    person_counts: List[ReservationReservationPersonCount] = FieldInfo(alias="PersonCounts")
