...
__all__ = [
    ...
    "RestrictionRestrictionConditions",
    "RestrictionRestrictionConditionsHours",
    "RestrictionRestrictionExceptions",
    "RestrictionRestrictionExceptionsMaxPrice",
    "RestrictionRestrictionExceptionsMinPrice",
]


class RestrictionRestrictionConditionsHours(BaseModel):
...
class RestrictionRestrictionConditions(BaseModel):
    ...
    hours: Optional[RestrictionRestrictionConditionsHours] = FieldInfo(alias="Hours", default=None)
...
class RestrictionRestrictionExceptionsMaxPrice(BaseModel):
...
class RestrictionRestrictionExceptionsMinPrice(BaseModel):
    currency: str = FieldInfo(alias="Currency")
...
class RestrictionRestrictionExceptions(BaseModel):
    ...
    max_price: Optional[RestrictionRestrictionExceptionsMaxPrice] = FieldInfo(alias="MaxPrice", default=None)
    ...
    min_price: Optional[RestrictionRestrictionExceptionsMinPrice] = FieldInfo(alias="MinPrice", default=None)
    """Total price of the reservation."""


class RestrictionRestriction(BaseModel):
    conditions: RestrictionRestrictionConditions = FieldInfo(alias="Conditions")
    """
    ...
    exceptions: Optional[RestrictionRestrictionExceptions] = FieldInfo(alias="Exceptions", default=None)
    """
...
class Restriction(BaseModel):
    ...
    restriction: Optional[RestrictionRestriction] = FieldInfo(alias="Restriction", default=None)
    """The added restriction."""


class RestrictionAddResponse(BaseModel):
    restrictions: Optional[List[Restriction]] = FieldInfo(alias="Restrictions", default=None)
