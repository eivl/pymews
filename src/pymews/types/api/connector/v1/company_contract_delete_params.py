...
__all__ = ["CompanyContractDeleteParams"]


class CompanyContractDeleteParams(TypedDict, total=False):
    ...
    travel_agency_contract_ids: Required[Annotated[List[str], PropertyInfo(alias="TravelAgencyContractIds")]]
