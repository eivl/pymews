...
__all__ = ["MessageThreadListParams", "Limitation", "CreatedUtc", "UpdatedUtc"]


class MessageThreadListParams(TypedDict, total=False):
    ...
    message_thread_ids: Annotated[Optional[List[str]], PropertyInfo(alias="MessageThreadIds")]
    """
