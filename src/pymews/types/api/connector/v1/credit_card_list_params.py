...
__all__ = ["CreditCardListParams", "Limitation", "UpdatedUtc"]


class CreditCardListParams(TypedDict, total=False):
    ...
    credit_card_ids: Annotated[Optional[List[str]], PropertyInfo(alias="CreditCardIds")]
    """
