...
__all__ = ["CommandListByIDsParams", "Limitation"]


class CommandListByIDsParams(TypedDict, total=False):
    ...
    command_ids: Required[Annotated[List[str], PropertyInfo(alias="CommandIds")]]
    """
