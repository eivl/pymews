...
__all__ = ["ServiceOrderNoteListParams", "Limitation", "UpdatedUtc"]


class ServiceOrderNoteListParams(TypedDict, total=False):
    ...
    service_order_ids: Required[Annotated[List[str], PropertyInfo(alias="ServiceOrderIds")]]
    ...
    service_order_note_ids: Annotated[Optional[List[str]], PropertyInfo(alias="ServiceOrderNoteIds")]
    ...
    types: Annotated[
        Optional[List[Literal["General", "ChannelManager", "SpecialRequest"]]], PropertyInfo(alias="Types")
    ]
    """Type of the service order note. Defaults to `["General", "ChannelManage"]`."""

    updated_utc: Annotated[Optional[UpdatedUtc], PropertyInfo(alias="UpdatedUtc")]
    """
    Timestamp in UTC timezone ISO 8601 format when the service order note was
    updated.
    """
