...
__all__ = ["V1ListAgeCategoriesParams", "Limitation", "UpdatedUtc"]


class V1ListAgeCategoriesParams(TypedDict, total=False):
    ...
    age_category_ids: Annotated[Optional[List[str]], PropertyInfo(alias="AgeCategoryIds")]
    """
    ...
    """Unique identifiers of `Services` associated with the age categories.

    If not provided, defaults to all bookable services.
    """
