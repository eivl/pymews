...
__all__ = ["V1ListOutletsParams", "Limitation", "UpdatedUtc"]


class V1ListOutletsParams(TypedDict, total=False):
    ...
    outlet_ids: Annotated[Optional[List[str]], PropertyInfo(alias="OutletIds")]
    """
