...
__all__ = ["V1ListCountersParams", "Limitation", "UpdatedUtc"]


class V1ListCountersParams(TypedDict, total=False):
    ...
    counter_ids: Annotated[Optional[List[str]], PropertyInfo(alias="CounterIds")]
