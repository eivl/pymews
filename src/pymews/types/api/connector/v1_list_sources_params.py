...
__all__ = ["V1ListSourcesParams", "Limitation", "UpdatedUtc"]


class V1ListSourcesParams(TypedDict, total=False):
    ...
    source_ids: Annotated[Optional[List[str]], PropertyInfo(alias="SourceIds")]
    """
