...
__all__ = ["V1ListResourceCategoryImageAssignmentsParams", "Limitation", "UpdatedUtc"]


class V1ListResourceCategoryImageAssignmentsParams(TypedDict, total=False):
    ...
    resource_category_image_assignment_ids: Annotated[
        Optional[List[str]], PropertyInfo(alias="ResourceCategoryImageAssignmentIds")
    ]
    """
    Unique identifiers of
