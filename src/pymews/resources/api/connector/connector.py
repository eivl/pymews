...
class ConnectorResourceWithRawResponse:
    ...
    def v1(self) -> V1ResourceWithRawResponse:
        return V1ResourceWithRawResponse(self._connector.v1)
...
class AsyncConnectorResourceWithRawResponse:
    ...
    def v1(self) -> AsyncV1ResourceWithRawResponse:
        return AsyncV1ResourceWithRawResponse(self._connector.v1)
...
class ConnectorResourceWithStreamingResponse:
    ...
    def v1(self) -> V1ResourceWithStreamingResponse:
        return V1ResourceWithStreamingResponse(self._connector.v1)
...
class AsyncConnectorResourceWithStreamingResponse:
    ...
    def v1(self) -> AsyncV1ResourceWithStreamingResponse:
        return AsyncV1ResourceWithStreamingResponse(self._connector.v1)
